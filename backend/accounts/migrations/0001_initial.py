...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('balance_inr', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('topup', 'Manual Top-up'), ('refund', 'Refund'), ('upi', 'UPI'), ('card', 'Card'), ('cash', 'Cash'), ('admin', 'Admin Adjustment'), ('system', 'System')], default='system', max_length=20)),
